...
El sistema MUST presentar las acciones de consultar y crear movimientos, y acceder al resumen financiero, como tarjetas independientes con icono, título y descripción. Cada tarjeta MUST tener un área completa activable, ser accesible mediante teclado y proporcionar estados de foco y hover perceptibles con contraste suficiente. La interfaz de Home MUST mantener una presentación responsive basada principalmente en blanco, negro y tonos grises.
